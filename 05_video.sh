...
python main.py video --gpu=1 --xla=2 --model_dir=optimised_model --video_file_in=../../videos/20170905_DrivePX/quick_test01.mp4 --video_file_out=../../videos/20170905_DrivePX/quick_test01_segmented.mp4
