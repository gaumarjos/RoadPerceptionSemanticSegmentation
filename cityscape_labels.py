...
labels = [
    ...
    Label(  'unlabeled'            ,  0 ,      0  , 'void'            , 0       , False        , True         , off           ),
    Label(  'ego vehicle'          ,  1 ,      1  , 'void'            , 0       , False        , True         , off           ),
    Label(  'rectification border' ,  2 ,      2  , 'void'            , 0       , False        , True         , off           ),
    Label(  'out of roi'           ,  3 ,      3  , 'void'            , 0       , False        , True         , off           ),
    Label(  'static'               ,  4 ,      4  , 'void'            , 0       , False        , True         , off           ),
    Label(  'dynamic'              ,  5 ,      5  , 'void'            , 0       , False        , True         , off           ),
    ...
    Label(  'sky'                  , 23 ,      23 , 'sky'             , 5       , False        , False        , off           ),
